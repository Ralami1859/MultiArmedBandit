% Algorithme Thompson Sampling Oracle en environnement dynamique
% BernoulliMeansMatrix = NbrPeriode * NbrAction

function GlobalRegretTS = ThompsonSamplingOracle(BernoulliMeansMatrix, VectHorizon, alpha0, beta0, NbrIteration)
...
title('Thompson Sampling Oracle')
end